 ...
 * Cela signifie qu'il n'est pas possible de créer plusieurs instances de cette classe.
...
class DBManager
{
     ...
     * Ce constructeur est privé. Pour récupérer une instance de la classe,
     * il faut utiliser la méthode getInstance().
