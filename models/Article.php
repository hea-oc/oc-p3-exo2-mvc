...
class Article extends AbstractEntity
{
     ...
     * Si le contenu est plus grand que $length, on retourne les $length premiers caractères
     * avec "..." à la fin.
     * @return string
     */
     ...
     * Récupère les vues d'un article.
     * @return int
     */
